<template>
    <div class="relative flex flex-col items-center w-full bg-black bg-opacity-70 py-10">
        <div class="relative flex flex-col items-center w-full max-w-[1300px] rounded-lg shadow-lg px-5 py-10">
            ...
            <!-- Form Pencarian -->
            <form class="max-w-2xl w-full mt-8">
                <div class="flex relative w-full">
                    <!-- Tombol Sidebar untuk Mobile -->
                    <button @click="toggleSidebar" class="md:hidden px-4 py-3 bg-black text-white border border-white rounded-l-lg">
                        ☰
                    </button>
                    ...
                    <div class="relative hidden md:block">
                        <button @click="toggleDropdown" type="button"
                            class="shrink-0 z-10 inline-flex items-center py-3 px-5 text-base font-medium text-white bg-black border border-white rounded-l-lg hover:text-gray-300 focus:ring-4 focus:outline-none focus:ring-gray-500">
                            {{ selectedCategory }}
                        ...
                        <div v-if="showDropdown" class="absolute top-full left-0 w-48 bg-black text-white rounded-lg shadow-lg mt-2 border border-gray-700 z-50 transition-opacity duration-300">
                    ...
                    <div class="relative flex-grow">
                        <input type="search" id="search-dropdown"
                            class="block p-3 w-full text-base text-white bg-black border border-white rounded-r-lg focus:ring-gray-500 focus:border-gray-500"
                            placeholder="Search Mockups, Logos, Design Templates..." required />

                        <!-- Tombol Search -->
                        <button type="submit"
                            class="absolute top-0 right-0 p-3 text-black bg-white rounded-r-lg border border-white hover:bg-gray-300 focus:ring-4 focus:outline-none focus:ring-gray-500">
