<template>
    <section
        class="relative flex items-center justify-center w-full h-screen max-sm:h-[500px]"
    >
        <img
        ...
        <h1
            class="relative text-center text-white uppercase font-bellefair text-5xl max-md:text-6xl max-sm:text-4xl max-w-[1141px] px-5"
        >
