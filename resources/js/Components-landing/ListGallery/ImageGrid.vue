<template>
    <section class="w-full bg-black py-16 px-6 md:px-10">
        <div class="max-w-[1192px] mx-auto">
            ...
            <!-- Empty State -->
            <div v-else-if="!photos.length" class="flex flex-col items-center justify-center py-20 text-white">
                ...
                <p class="text-gray-400">There are no photos available in this gallery yet.</p>
            </div>
