<template>
    ...
    >
        ...
        >
            ...
            >
                <div class="flex items-center gap-2">
                    <div
                        class="w-6 h-6 rounded-full overflow-hidden bg-gray-700 border border-white/20"
                    >
                        <img
                            :src="userAvatar"
                            :alt="userName"
        ...
        <div class="p-5 text-center">
            <h3
                class="font-semibold text-black dark:text-white leading-snug mb-2 line-clamp-2"
                :class="titleClass"
            >
                {{ title || "Untitled" }}
            </h3>
...
const props = defineProps({
    thumbnailUrl: {
        type: String,
        required: true,
        default: "/js/Assets/default-photo.jpg",
    },
    title: {
        type: String,
        required: true,
