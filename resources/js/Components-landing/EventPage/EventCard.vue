        ...
        <div class="p-5 text-center">
            ...
            <div class="flex flex-wrap justify-center gap-2 mb-2">
                <p v-if="date_start" class="text-xs text-gray-300">
                    {{ formatDate(date_start) }}</p>
                <p v-if="date_end" class="text-xs text-gray-300">- {{ formatDate(date_end) }}
                </p>
            </div>
            ...
            <div class="flex justify-center gap-3 mt-3">
                <a v-if="instagramUrl && instagramUrl.trim().length > 0" :href="instagramUrl" target="_blank"
                ...
                <a v-if="youtubeUrl && youtubeUrl.trim().length > 0" :href="youtubeUrl" target="_blank"
                ...
                <a v-if="websiteUrl && websiteUrl.trim().length > 0" :href="websiteUrl" target="_blank"
                ...
                <a v-if="googleMapsUrl && googleMapsUrl.trim().length > 0" :href="googleMapsUrl" target="_blank"
