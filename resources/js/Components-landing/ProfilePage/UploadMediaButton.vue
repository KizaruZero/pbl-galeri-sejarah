        ...
        <div v-if="modelValue" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
            <div class="bg-[#1e1e1e] rounded-lg p-6 w-full max-w-md">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <button @click="$emit('upload-photo')"
                        class="flex flex-col items-center justify-center p-4 bg-[#2a2a2a] rounded-lg hover:bg-[#3a3a3a] transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-blue-400 mb-2" fill="none"
                    ...
                    <button @click="$emit('upload-video')"
                        class="flex flex-col items-center justify-center p-4 bg-[#2a2a2a] rounded-lg hover:bg-[#3a3a3a] transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-red-400 mb-2" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
const emit = defineEmits(['update:modelValue', 'upload-photo', 'upload-video']);
