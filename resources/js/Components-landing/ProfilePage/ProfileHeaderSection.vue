      ...
      <div class="flex flex-col col-span-1 items-center md:items-start">
        ...
        <div class="text-black dark:text-white text-center md:text-left px-2 sm:px-0">
          <div class="flex items-center justify-center md:justify-start gap-2">
            <h1 class="text-lg sm:text-2xl md:text-3xl font-medium mb-1 sm:mb-2">
              {{ userData?.name }}
            </h1>
            <button
              @click="openModal"
        ...
        >
          <div class="flex flex-col items-center px-2 sm:px-0">
            <span
              ...
              >{{ stats.posts }}</span
            >
            <span class="text-black dark:text-white text-xs sm:text-sm md:text-base"
              >UNGGAHAN</span
            >
          </div>
          <div class="flex flex-col items-center px-2 sm:px-0">
      ...
      <div class="bg-white rounded-lg p-6 w-96 max-h-[80vh] overflow-y-auto">
        ...
        <div v-if="favoritesList?.length > 0" class="space-y-3">
          ...
          >
            <img
              :src="
                favorite.user_photo ? `/storage/${favorite.user_photo}` : defaultPhoto
              "
...
const downloadTemplate = () => {
  ...
  link.href = "storage/excel/metadata_template.xlsx";
