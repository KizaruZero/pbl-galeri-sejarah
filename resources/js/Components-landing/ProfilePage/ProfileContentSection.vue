        ...
        <div class="mt-6 sm:mt-8 md:mt-12 container mx-auto">
            ...
            >
                <div
                    ...
                    :key="'photo-' + photo.id"
                    class="rounded-md sm:rounded-lg shadow-md cursor-pointer"
                >
                    ...
                    <div
                        class="mt-1 text-center text-xl font-medium text-white"
                    >
                        {{ photo.title }}
                    </div>
                    <!-- status badge -->
                    ...
                    >
                        <span
                            ...
                            :class="{
                                ...
                                'text-gray-500': photo.status === 'pending',
                            }"
                        >
                            {{ photo.status }}
                        </span>
                    ...
                    <div
                        ...
                        class="mt-1 text-center text-xl font-medium text-red-200"
                    >
                        Your Photos Get Rejected Because of {{ photo.note }}
                    </div>
                </div>
            </div>
                ...
                >
                    ...
                    >
                        <span
                            class="text-xl"
                            :class="{
                                'text-green-500': video.status === 'approved',
                                'text-red-500': video.status === 'rejected',
                                'text-gray-500': video.status === 'pending',
                            }"
                        >
                            {{ video.status }}
                        </span>
                    ...
                    <div
                        ...
                        class="mt-1 text-center text-xl font-medium text-red-200"
                    >
                        Your Videos Get Rejected Because of {{ video.note }}
                    </div>
                </div>
            </div>
