<template>
    <div
        class="relative flex flex-col items-center w-full bg-white dark:bg-black py-10"
    >
        <div
            class="relative flex flex-col items-center w-full max-w-[1300px] rounded-lg shadow-lg px-5 py-10"
        >
            <!-- Search Form -->
            <form @submit.prevent="handleSearch" class="w-full mt-8">
                <div class="flex w-full">
                    ...
                    <div class="flex-grow relative">
                        <input
                            ...
                            placeholder="Search Mockups, Logos, Design Templates, Users, Locations..."
                            required
                        />
                        <button
                            type="submit"
                ...
                <div class="flex items-center justify-between mt-4">
                    <div class="flex items-center space-x-4">
                        <label
                            class="flex items-center text-sm text-black dark:text-white"
                        >
                            <input
                                type="checkbox"
                                v-model="useFuzzySearch"
                ...
                <div v-else>
                    ...
                    <div v-if="photoResults.length > 0" class="mb-12">
                        ...
                        >
                            ...
                            >
                                <a
                                    @click.prevent="navigateToDetail(photo)"
                                ...
                                >
                                    ...
                                    <div class="p-4">
                                        <h3
                                            class="text-black dark:text-white font-semibold text-lg mb-2 line-clamp-2"
                                        >
                                            {{ photo.title }}
                                        </h3>
                                        <p
                                            class="text-gray-800 dark:text-gray-200 text-sm mb-3 line-clamp-2"
                                        >
                                            {{
                                                truncateDescription(
                                                    photo.description
                    ...
                    <div v-if="videoResults.length > 0" class="mb-12">
                        ...
                        >
                            ...
                            >
                                <a
                                    @click.prevent="navigateToDetail(video)"
                                    class="block cursor-pointer"
                                >
                                    <div class="relative">
                                        <img
                                    ...
                                    <div class="p-4">
                                        ...
                                        >
                                            ...
                                            <div
                                                v-if="video.metadata.resolution"
                                                class="flex items-center"
                                            >
                                                <span class="mr-1">🎬</span>
                                                <span>{{
                                            ...
                                            <div
                                                v-if="video.metadata.frame_rate"
                                                class="flex items-center"
                                            >
                                                <span class="mr-1">🎯</span>
                                                <span
...
const performFuzzySearch = (query) => {
    ...
    results.forEach((result) => {
        const item = { ...result.item, score: result.score };
        if (item.type === "photo") {
            photos.push(item);
        } else if (item.type === "video") {
            videos.push(item);
