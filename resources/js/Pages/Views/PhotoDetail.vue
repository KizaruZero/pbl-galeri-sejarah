                    ...
                    <div class="relative w-full">
                        ...
                        <div class="w-full overflow-hidden">
                            <img :src="photo.imageUrl" :alt="photo.altText"
                                class="w-full h-auto  object-cover bg-gray-950 mt-14" />
                        </div>
                        ...
                        <div class="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/80 to-transparent">
                            <div class="flex items-center gap-3">
                                <div class="w-10 h-10 rounded-full overflow-hidden border-2 border-white/20">
                                    <img :src="photo.user?.photoProfile || '/default-avatar.jpg'"
                                        :alt="photo.user?.name" class="w-full h-full object-cover"
                ...
                <div class="p-6 ml-14 mr-14">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                        ...
                        <div>
                            ...
                            <p class="text-white">
                                {{ photo.file_size ? formatFileSize(parseInt(photo.file_size)) : 'Not specified' }} </p>
                        </div>
                        <div>
