    ...
    <MainLayout>
        <div class="min-h-screen bg-black py-12 px-4 sm:px-6 lg:px-8 mt-12">
            <div class="max-w-4xl mx-auto mt-6">
                <!-- Back Button -->
                <button @click="$router.go(-1)" class="mb-6 flex items-center text-gray-400 hover:text-blue-300 transition-colors">
                ...
                <div class="bg-gray-900 rounded-lg shadow-xl overflow-hidden border border-gray-800">
                        ...
                        <div class="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/80 to-transparent">
                            <div class="flex items-center gap-3">
                                <div class="w-10 h-10 rounded-full overflow-hidden border-2 border-white/20">
                                    <img :src="photo.user?.avatar || '/default-avatar.jpg'" 
                                         :alt="photo.user?.name"
                                         class="w-full h-full object-cover"
                                         @error="handleAvatarError">
                                </div>
                                <div>
                                    <p class="text-white font-medium">{{ photo.user?.name || 'Unknown Photographer' }}</p>
                    ...
                    <div class="p-6">
                        ...
                        <!-- Description -->
                        <p class="text-gray-300 mb-6 whitespace-pre-line">{{ photo.description }}</p>

                        <!-- Tags -->
                        <div class="flex flex-wrap gap-2 mb-6" v-if="photo.tags && photo.tags.length">
                            <router-link v-for="tag in photo.tags" :key="tag" 
                                    ...
                                    <div class="flex justify-between items-start">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-gray-400 text-xs">{{ formatRelativeDate(comment.date) }}</p>
                                            </div>
                                        </div>
