<template>
  <MainLayout>
    <div class="min-h-screen flex flex-col items-center justify-center bg-black text-white p-6">
      <button @click="$router.back()" class="absolute top-4 left-4 flex items-center text-white text-lg hover:text-gray-400">
      ...
      <template v-else>
        <p class="text-red-500 text-xl">Artikel tidak ditemukan.</p>
      </template>
    </div>
  </MainLayout>
</template>
