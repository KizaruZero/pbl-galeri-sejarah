<template>
  <div class="min-h-screen bg-gray-100 dark:bg-gray-900 p-6">
    <div class="max-w-3xl mx-auto bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
      <h1 class="text-3xl font-bold text-gray-800 dark:text-white mb-4">📦 Bulk Upload ZIP</h1>

      <p class="text-gray-600 dark:text-gray-300 mb-6">
        Upload satu file <strong>.zip</strong> yang berisi <code>metadata.xlsx</code> dan folder <code>media/</code> berisi foto/video.
      </p>
      ...
      >
        ...
        <p class="text-gray-600 dark:text-gray-300">Drag & Drop ZIP file here or click to select</p>
      ...
      <!-- Upload Result -->
      <div v-if="message" class="mt-4 p-4 rounded-xl bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200">
        {{ message }}
      </div>
      ...
      <!-- Tips Section -->
      <div class="mt-8">
        <h2 class="text-lg font-bold text-gray-700 dark:text-white mb-2">📝 Struktur ZIP yang benar:</h2>
