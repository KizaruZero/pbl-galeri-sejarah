          ...
          <div class="space-y-6">
            ...
            <div>
              ...
              <div class="w-full aspect-video border-2 border-dashed border-gray-500 rounded-lg overflow-hidden hover:bg-[#1f1f1f] transition cursor-pointer relative">
                ...
                <div v-else class="h-full flex flex-col items-center justify-center p-6" @click="$refs.fileInput.click()">
                  <svg class="h-12 w-12 text-gray-400 mb-4" stroke="currentColor" fill="none" viewBox="0 0 48 48">
                    <path d="M14 22l6 6 14-14" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
...
onMounted(async () => {
  try {
    ...
    Swal.fire('Error', 'Failed to load photo data', 'error');
  }
});
