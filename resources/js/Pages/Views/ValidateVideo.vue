                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div v-if="videoData.thumbnailPreview" class="mt-4">
                                <label class="block text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">Thumbnail</label>
                                <img
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <p class="text-black dark:text-white">{{ videoData.title }}</p>
                            </div>
                            ...
                            <div v-if="videoData.description">
                                ...
                                <p class="text-black dark:text-white">{{ videoData.description }}</p>
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Source</label>
                                <p class="text-black dark:text-white">{{ videoData.source }}</p>
                            </div>

                            <div v-if="videoData.tag">
                                <label class="block text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Tags</label>
                                <p class="text-black dark:text-white">{{ videoData.tag }}</p>
                            </div>

                            <div v-if="videoData.link_youtube">
                                <label class="block text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">YouTube Link</label>
                                <p class="text-black dark:text-white break-all">{{ videoData.link_youtube }}</p>
                            </div>

                            <div v-else-if="videoData.videoName && !videoData.youtubeVideoId">
                                <label class="block text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Video Type</label>
                                <p class="text-black dark:text-white">Uploaded File</p>
                            </div>
