<template>
    <MainLayout>
        <div class="mx-auto p-6 bg-[#0d0d0d] max-w-full">
            ...
            <h2 class="text-2xl font-bold text-center text-white mt-10 mb-8">CREATE CONTENT VIDEO</h2>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <span v-if="videoName"
                                    class="text-sm text-white truncate max-w-xs">{{ videoName }}</span>
                            </div>

                            <!-- Video Preview Section -->
                            <div v-if="videoPreview" class="mt-3">
                                <video controls class="rounded-lg border border-[#333333] w-full max-h-60">
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-3">
                                <label for="thumbnail" class="cursor-pointer">
                                    ...
                                    <input type="file" id="thumbnail" @change="handleThumbnailUpload" accept="image/*"
                                        class="hidden">
                                </label>
                                <span v-if="thumbnailName"
                                    class="text-sm text-white truncate max-w-xs">{{ thumbnailName }}</span>
                            </div>
...
<script setup>
    ...
    const submitForm = () => {
        ...
        // You would typically send both form.value.video and form.value.thumbnail to your backend
    };
